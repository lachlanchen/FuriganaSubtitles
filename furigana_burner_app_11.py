...
def main():
    ...
    parser = argparse.ArgumentParser(description='Simple Grammatical Furigana Burner')
    parser.add_argument('video', nargs='?', help='Input video file')
    parser.add_argument('subtitles', nargs='?', help='Input subtitle file')
    ...
    if len(sys.argv) == 1:
        ...
        if video_files and subtitle_files:
            ...
            if success:
                print("\n🎉 SUCCESS! Simple furigana processing completed!")
            else:
                print("\n❌ FAILED!")
        else:
