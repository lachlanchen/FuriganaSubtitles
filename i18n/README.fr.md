...
Outil Python pour incruster des sous-titres japonais avec furigana directement dans la vidéo, sans ffmpeg.

## Fonctionnalités

- 🎌 **Génération automatique** : MeCab (fugashi) ou pykakasi
- 🎨 **Rendu propre** : alignement et espacement précis
- 📺 **Traitement direct** : OpenCV image par image
- 🔤 **Détection de polices** : recherche de polices japonaises
- ⚡ **Traitement par lot** : plusieurs vidéos
- 🎯 **Position précise** : contrôle des marges
...
Contributions bienvenues pour améliorer l’algorithme et les performances.
