...
CRITICAL: Provide complete, accurate furigana for the entire word. """
    ...
    def _create_simple_words(self, text: str) -> List[GrammaticalWord]:
        """Create simple words for non-Japanese text - no AI, no spaces"""
        # For non-Japanese languages, treat the entire text as one unit
...
def main():
    ...
    parser = argparse.ArgumentParser(description='Furigana Burner with Audio Support and Japanese-only AI Analysis')
